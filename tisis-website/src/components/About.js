    ...
    <section className="about">
      ...
      <div className="about-sections">
        ...
        <div className="about-section">
          <img src={kingsLegacyImage} alt="The King's Legacy, a summary of Tisis' plot." className="about-image" />
        ...
        <div className="about-section">
          <img src={surviveMadnessImage} alt="Survive the Madness, explaining the gameplay of Tisis." className="about-image" />
        ...
        <div className="about-section">
          <img src={behindVeilImage} alt="Behind the Veil, information regarding development." className="about-image" />
